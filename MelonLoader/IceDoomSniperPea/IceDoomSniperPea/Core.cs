...
namespace IceDoomSniperPea
{
    public class Core : MelonMod
    {
        public override void OnInitializeMelon()
        {
            ...
            IceDoomSniperPea.buff1 = CustomCore.RegisterCustomBuff("瞬狙：冰毁狙击的狙击间隔缩短为4秒，每次攻击有概率连狙", BuffType.AdvancedBuff, () => Board.Instance.ObjectExist<IceDoomSniperPea>(), 5000, "#000000", (PlantType)IceDoomSniperPea.PlantID, bgType: TravelBuffOptionButton.BgType.Night);
            IceDoomSniperPea.buff2 = CustomCore.RegisterCustomBuff("狙狙爆：冰毁狙击每次狙击都释放一次寒冰毁灭菇效果", BuffType.AdvancedBuff, () => Board.Instance.ObjectExist<IceDoomSniperPea>(), 5000, "#000000", (PlantType)IceDoomSniperPea.PlantID, bgType: TravelBuffOptionButton.BgType.Night);
            ...
            IceDoomSniperPea.buff3 = CustomCore.RegisterCustomBuff("背起了行囊：冰毁狙击每次狙击都造成21亿伤害，2级时，每次攻击必定击败范围1格的僵尸，攻击间隔降至0.5秒。", BuffType.AdvancedBuff, () => Board.Instance.ObjectExist<IceDoomSniperPea>() && Lawnf.TravelAdvanced(IceDoomSniperPea.buff1) && Lawnf.TravelAdvanced(IceDoomSniperPea.buff2), 15000, "#000000", (PlantType)IceDoomSniperPea.PlantID, 2, TravelBuffOptionButton.BgType.Night);
